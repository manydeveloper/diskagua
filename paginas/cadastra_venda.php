...
<section  class="well well-lg" style="margin-left: 80px; margin-top: 10px; float: left; width: 78%; margin-bottom:0px; ">
<fieldset>
            <legend>
                Cadastra Venda
            </legend>   
    ...
    <form name="formVendas" action="../functions/cadastra_venda_sql.php" method="post" onsubmit="return verificaFormVenda()">
        ...
        <fieldset>
            ...
            <input type="hidden" name="idCliente" value="<?php if($verifica == true){echo $cliente["idCliente"];}else{echo"0";} ?>">
            <label>Nome</label><input type="text" name="nomeCliente" id="inputnome" readonly style="width: 60%;" value=" <?php if($verifica == true){echo $cliente["nome"];} else {echo 'Nome Cliente';} ?>" >             
        <br>
        ...
        <input type="text" name="telefone" id="inputtelefone" readonly value="<?php if($verifica==true){echo $tel["telefone"];}  else {echo 'Telefone';} ?>">
        <br>
        <label>Saldo</label>
        <input type="number" name="saldo" id="inputSaldo" readonly value="<?php if($verifica==true){echo $cliente["saldo"];}  else {echo 'saldo';} ?>">
        <br>
        <label>Desconto Fixo</label>
        <input type="number" name="descFixo" id="inputDescFixo" readonly value="<?php if($verifica==true){echo $cliente["descFixo"];}  else {echo 'Desconto Fixo';} ?>">
        <br>
        <label>Limite Credito</label>
        <input type="number" name="limiteCredito" id="inputLCredito" readonly value="<?php if($verifica==true){echo $cliente["limiteCredito"];}  else {echo 'Limite Credito';} ?>">
        <br>
        ...
        <div id="tabelaVendaProduto">
            <table id="tabelaItem" cellspacing=0  >
            ...
            <div id="fundoValores">
                ...
                <input class="pula" style="width: 15%;" type="number" name="valorDesconto" id="inputValorDesconto" value="<?php if(!empty($cliente["descFixo"])){echo $cliente["descFixo"] ;}else{ echo 0; };?>" onchange="calcValorTotal()">
